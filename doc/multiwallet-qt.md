...
In order to support loading of multiple wallets in wavercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wavercoin.cpp.
...
Changes to wavercoin.cpp
----------------------
wavercoin.cpp is the entry point into wavercoin-qt, and as such, will require some minor modifications to provide hooks for
