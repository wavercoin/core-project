...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/wavercoin-cli.cpp \
           src/wavercoin-tx.cpp \
           src/wavercoin.cpp \
           src/db.cpp \
           ...
           src/qt/wavercoin.cpp \
           src/qt/wavercoinstrings.cpp \
...
RESOURCES += src/qt/wavercoin.qrc src/qt/wavercoin_locale.qrc

TRANSLATIONS += src/qt/locale/wavercoin_bg.ts \
                src/qt/locale/wavercoin_ca.ts \
                src/qt/locale/wavercoin_cs.ts \
                src/qt/locale/wavercoin_da.ts \
                src/qt/locale/wavercoin_de.ts \
                src/qt/locale/wavercoin_en.ts \
                src/qt/locale/wavercoin_en_US.ts \
                src/qt/locale/wavercoin_eo.ts \
                src/qt/locale/wavercoin_es.ts \
                src/qt/locale/wavercoin_es_ES.ts \
                src/qt/locale/wavercoin_fi.ts \
                src/qt/locale/wavercoin_fr.ts \
                src/qt/locale/wavercoin_fr_FR.ts \
                src/qt/locale/wavercoin_hi_IN.ts \
                src/qt/locale/wavercoin_hr.ts \
                src/qt/locale/wavercoin_hr_HR.ts \
                src/qt/locale/wavercoin_it.ts \
                src/qt/locale/wavercoin_ja.ts \
                src/qt/locale/wavercoin_pl.ts \
                src/qt/locale/wavercoin_ko_KR.ts \
                src/qt/locale/wavercoin_lt_LT.ts \
                src/qt/locale/wavercoin_nl.ts \
                src/qt/locale/wavercoin_pl.ts \
                src/qt/locale/wavercoin_pt.ts \
                src/qt/locale/wavercoin_pt_BR.ts \
                src/qt/locale/wavercoin_ro_RO.ts \
                src/qt/locale/wavercoin_ru.ts \
                src/qt/locale/wavercoin_sk.ts \
                src/qt/locale/wavercoin_sv.ts \
                src/qt/locale/wavercoin_tr.ts \
                src/qt/locale/wavercoin_uk.ts \
                src/qt/locale/wavercoin_vi.ts \
                src/qt/locale/wavercoin_zh_CN.ts \
                src/qt/locale/wavercoin_zh_TW.ts