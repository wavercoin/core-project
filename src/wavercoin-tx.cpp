...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WVC Core wavercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wavercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wavercoin transaction") + "\n" +
                               "  wavercoin-tx [options] -create [commands]   " + _("Create hex-encoded wavercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wavercoin transaction
