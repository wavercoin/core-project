                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Waver-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WVC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wavercoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WVC Core"), this);
    aboutAction->setStatusTip(tr("Show information about WVC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WVC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WVC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WVC addresses"));
    ...
    openAction->setStatusTip(tr("Open a WVC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WVC Core help message to get a list with possible WVC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WVC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WVC network", "", count));
}
...
{
    QString strTitle = tr("WVC Core"); // default title
