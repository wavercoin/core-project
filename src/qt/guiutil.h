...
/** Utility functions used by the WVC Qt UI.
 */
namespace GUIUtil
{
...
// Render WVC addresses in monospace font
...
// Parse "wavercoin:" URI into recipient object, return true on successful parsing
