...
enum WalletFeature {
    FEATURE_BASE = 10500, // the earliest version new wallets suwavercoinrts (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 40000, // wallet encryption
    FEATURE_COMPRPUBKEY = 60000, // compressed public keys

    FEATURE_LATEST = 25605
};
...
public:
    ...
    //! check whether we are allowed to upgrade (or already suwavercoinrt) to the named feature
    bool CanSuwavercoinrtFeature(enum WalletFeature wf)
    {
    ...
    /// Get 1000WVC output and keys which can be used for the Masternode
