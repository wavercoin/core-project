...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WVC features */
        {"wavercoin", "masternode", &masternode, true, true, false},
        {"wavercoin", "masternodelist", &masternodelist, true, true, false},
        {"wavercoin", "mnbudget", &mnbudget, true, true, false},
        {"wavercoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"wavercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wavercoin", "mnsync", &mnsync, true, true, false},
        {"wavercoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wavercoind, or the -server option to wavercoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wavercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21505/\n";
}
