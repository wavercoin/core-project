...
#if defined(NDEBUG)
#error "WVC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "WVC Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 7202) {
		nSubsidy = 0.17 * COIN;
	} else if (nHeight > 7202 && nHeight <= 28803) {
		nSubsidy = 0.35 * COIN;
	} else if (nHeight > 28803 && nHeight <= 59044) {
		nSubsidy = 7 * COIN;
	} else if (nHeight > 59044 && nHeight <= 71835) {
		nSubsidy = 30 * COIN;
	} else if (nHeight > 71835 && nHeight <= 102245) {
		nSubsidy = 12 * COIN;
	} else if (nHeight > 102245 && nHeight <= 145446) {
		nSubsidy = 10 * COIN;
	} else if (nHeight > 145446 && nHeight <= 188647) {
		nSubsidy = 9 * COIN;
	} else if (nHeight > 188647 && nHeight <= 275048) {
		nSubsidy = 8 * COIN;
	} else if (nHeight > 275048 && nHeight <= 404649) {
		nSubsidy = 6 * COIN;
	} else if (nHeight > 404649 && nHeight <= 663850) {
		nSubsidy = 4 * COIN;
	} else if (nHeight > 663850 && nHeight <= 1383851) {
		nSubsidy = 2 * COIN;
	} else if (nHeight > 1383851) {
		nSubsidy = 1 * COIN;
	}
    return nSubsidy;
}
...
{
    RenameThread("wavercoin-scriptch");
